...
if (mysqli_num_rows($result) > 0) {
	...
	<td>
		<?php if(is_minLevel(2)) { echo "<a href='modupdated.php?modid=$id?muser=$userm' class='btn btn-success'>Submit</a>"; } else { echo "--"; } ?>
	</td>
	<td>
		<?php if(is_minLevel(2)) { echo "<a href='nomod.php?modid=$id?muser=$userm' class='btn btn-danger'>BE GONE!</a>"; } else { echo "--"; } ?>
	</td>
        </tr>
        <?php
        }
