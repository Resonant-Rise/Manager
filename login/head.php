...
<head>
	...
	<link rel='stylesheet' href='<?php echo $script_path; ?>assets/css/bootstrap/3.2.0/css/bootstrap.min.css'>
	<link rel='stylesheet' href='<?php echo $script_path; ?>assets/css/bootstrap/3.2.0/css/bootstrap-theme.css'>
	<?php
	...
	<link rel='stylesheet' href='<?php echo $script_path; ?>assets/css/bootstrap/3.2.0/css/default-theme.css'>
	<?php
	}
	?>
	...
	<script src='<?php echo $script_path; ?>assets/css/bootstrap/3.2.0/js/bootstrap.min.js'></script>
