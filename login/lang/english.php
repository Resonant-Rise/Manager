...
$m['activation_title'] = "Choose a activation method";
...
$m['social_pay'] = "Should people have to pay for registration if they login with social login? (only if you have enabled a payment gateway)";
...
$m['paypal'] = "Paypal";
$m['paypal_info'] = "Here you can enable Paypal so you can charge users for registration";
...
$m['paypal_cost'] = "Cost";
$m['paypal_cost_title'] = "Price to register on your site";

$m['stripe'] = "Stripe";
$m['stripe_settings_info'] = "Here you can enable and configure Stripe so you can charge users for registration. <a href='https://dashboard.stripe.com/register' target='_blank'>Click here</a> to register an account on Stripe.com";
...
$m['stripe_cost'] = "Cost";
$m['stripe_cost_title'] = "Price to register on your site";
