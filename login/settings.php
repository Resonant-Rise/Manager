	...
	<div class='container container-admin'>
		<div class='col-md-2'>
			...
			<nav>
				<ul class='nav nav-pills nav-stacked span2'>
					...
					<li><a href='?page=social'><?php echo $m['social_menu']; ?></a></li>
					<li><a href='?page=paypal'><?php echo $m['paypal_menu']; ?></a></li>
					<li><a href='?page=stripe'><?php echo $m['stripe_menu']; ?></a></li>
				</ul>
			</nav>
		</div>
		...
		?>
			...
			if(!empty($_GET['id'])) {
				...
				$getinput = mysqli_query($con,"SELECT * FROM inputs WHERE id='$id'");
				...
				<div class='row'>
					<div class='form-group'>
						...
						<div class='col-sm-8'>
							...
							<b>Public key</b> <input type='text' name='publickey'<?php echo getSetting("publickey", "value"); ?> class='form-control'><br>
							<b>Private key</b> <input type='text' name='privatekey'<?php echo getSetting("privatekey", "value"); ?> class='form-control'><br>
							</div>
							<div class='checkbox'>
				...
				<div id='inputs'>
					...
					?>
						<table class='table' id='input_table'>
							<thead>
								<tr>
									<td><b><?php echo $m['place']; ?></b></td>
									<td><b><?php echo $m['name']; ?></b></td>
									<td><b><?php echo $m['type']; ?></b></td>
									<td><b><?php echo $m['required']; ?></b></td>
									<td><b><?php echo $m['actions']; ?></b></td>
								</tr>
							</thead>
							<tbody>
							<?php
							...
							?>
								<tr>
									...
									<td>
										...
										<a class='up' title='<?php echo $m['up']; ?>'><button type='button' onclick='moveInput("<?php echo session_id(); ?>", "up", <?php echo $i['id']; ?>);' class='btn btn-primary'><span class='glyphicon glyphicon-chevron-up'></span></button></a>
										<a class='down' title='<?php echo $m['down']; ?>'><button type='button' onclick='moveInput("<?php echo session_id(); ?>", "down", <?php echo $i['id']; ?>);' class='btn btn-primary'><span class='glyphicon glyphicon-chevron-down'></span></button></a>
										<a class='delete' title='<?php echo $m['delete']; ?>'><button type='button' class='btn btn-danger' onclick='sureDeleteInput("<?php echo session_id(); ?>", <?php echo $i['id']; ?>, "<?php echo $m['delete']; ?>");'><span class='glyphicon glyphicon-trash'></span></button></a>
									</td>
								</tr>
							<?php
							}
		...
		?>
			...
			if(!empty($_GET['id'])) {
				$id = mysqli_real_escape_string($con,$_GET['id']);
				$getperm = mysqli_query($con,"SELECT * FROM permissions WHERE id='$id'");
				if(mysqli_num_rows($getperm) == 1) {
					...
					<?php
					$permid = $gp['id'];
					$users = mysqli_query($con,"SELECT * FROM users WHERE permission='$permid'");
							...
							<form method='post' id='move_user'>
								<div class='row'>
									<table class='table table-striped table-hover' id='putable'>
										<thead>
											<tr>
												<td><b><input type='checkbox' id='selectall'></b></td>
				...
				<div class='row row-2'>
					<div id='perm_table'>
						<table class='table' id='ptable'>
							<thead>
								<tr>
									<td><b><a id='level_warning' title='<?php echo $m['level_warning']; ?>'><?php echo $m['level']; ?></a></b></td>
									<td><b><?php echo $m['name']; ?></b></td>
							...
							<tbody>
								...
								while($p = mysqli_fetch_array($permissions)) {
									$id = $p['id'];
									$countusers = mysqli_query($con,"SELECT id FROM users WHERE permission='$id'");
									...
									?>
										<tr class='info'>
											...
											<td>
												<a class='edit' title='<?php echo $m['edit']; ?>' href='?page=permissions&id=<?php echo $p['id']; ?>'><button type='button' class='btn btn-success'><span class='glyphicon glyphicon-pencil'></span></button></a>
												<a class='up' title='<?php echo $m['up']; ?>'><button type='button' onclick='actionForm("<?php echo session_id(); ?>", "up", <?php echo $p['id']; ?>);' class='btn btn-primary'><span class='glyphicon glyphicon-chevron-up'></span></button></a>
												<a class='down' title='<?php echo $m['down']; ?>'><button type='button' onclick='actionForm("<?php echo session_id(); ?>", "down", <?php echo $p['id']; ?>);' class='btn btn-primary'><span class='glyphicon glyphicon-chevron-down'></span></button></a>
									...
									?>
										<tr>
											...
											<td>
												...
												<a class='up' title='<?php echo $m['up']; ?>'><button type='button' onclick='actionForm("<?php echo session_id(); ?>", "up", <?php echo $p['id']; ?>);' class='btn btn-primary'><span class='glyphicon glyphicon-chevron-up'></span></button></a>
												<a class='down' title='<?php echo $m['down']; ?>'><button type='button' onclick='actionForm("<?php echo session_id(); ?>", "down", <?php echo $p['id']; ?>);' class='btn btn-primary'><span class='glyphicon glyphicon-chevron-down'></span></button></a>
												<a class='delete' title='<?php echo $m['delete']; ?>'><button type='button' class='btn btn-danger' onclick='sureDeletePerm("<?php echo session_id(); ?>", <?php echo $p['id']; ?>, "<?php echo $m['delete']; ?>");'><span class='glyphicon glyphicon-trash'></span></button></a>
											</td>
										</tr>
									<?php
									}
