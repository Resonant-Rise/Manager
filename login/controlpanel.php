...
?>
	...
	<div class='container container-admin'>
		...
		<div class='col-md-10'>
				...
				<div class='tab-content'>
					<div role='tabpanel' class='tab-pane active' id='users'>
						<table class='table'>
							<thead>
								<tr>
									<td><b>Users today</b></td>
									<td><b>Users yesterday</b></td>
									<td><b>Users this month</b></td>
									<td><b>Users this year</b></td>
					...
					<div role='tabpanel' class='tab-pane' id='logandblock'>
						<table class='table'>
							<thead>
								<tr>
									<td><b>Logins today</b></td>
									<td><b>Logins total</b></td>
									<td><b>Blocks today</b></td>
									<td><b>Blocks total</b></td>
								</tr>
							</thead>
							<tbody>
								<?php
								...
								$logins = mysqli_query($con,"SELECT * FROM log WHERE success='1'");
						...
						$login = mysqli_query($con,"SELECT * FROM log WHERE success='1' AND time BETWEEN ". $seven_days_ago ." AND ". $now);
						...
						$block = mysqli_query($con,"SELECT * FROM blocks WHERE time BETWEEN ". $seven_days_ago ." AND ". $now);
					...
					<div role='tabpanel' class='tab-pane' id='permissions'>
						<table class='table'>
							...
							<tbody>
								<?php
								$permissions = mysqli_query($con,"SELECT * FROM permissions ORDER BY level DESC");
								while($p = mysqli_fetch_array($permissions)) {
									$permid = $p['id'];
									$usertotal = mysqli_query($con,"SELECT * FROM users WHERE permission='$permid'");
								?>
									<tr>
						...
						var pchartData = [
							<?php
							$perms = mysqli_query($con,"SELECT * FROM permissions ORDER BY level DESC");
					...
					<div role='tabpanel' class='tab-pane' id='messages'>
						<table class='table'>
							<thead>
								<tr>
									<td><b>Messages today</b></td>
									<td><b>Messages yesterday</b></td>
									<td><b>Messages this month</b></td>
									<td><b>Messages this year</b></td>
					...
					<div role='tabpanel' class='tab-pane' id='ipstats'>
						...
						$logcheck = mysqli_query($con,"SELECT * FROM log WHERE ip='$ip'");
						$usercheck = mysqli_query($con,"SELECT * FROM users WHERE ip='$ip' ORDER BY id DESC");
						?>
							<?php
							...
							if(mysqli_num_rows($logcheck) == 0 && mysqli_num_rows($usercheck) == 0) {
								...
								$goodlogs = mysqli_query($con,"SELECT * FROM log WHERE ip='$ip' AND success='1'");
								$badlogs = mysqli_query($con,"SELECT * FROM log WHERE ip='$ip' AND success='0'");
								...
								<div class='row'>
									<div class='form-group'>
										<div class='row'>
											...
											<div class='col-sm-7'>
												<input type='date' name='from' class='form-control' value='<?php echo date("Y-m-d"); ?>' id='from_messages' oninput='countItems("<?php echo session_id(); ?>", "messages");'>
											</div>
											<div class='col-sm-1'>
										...
										<div class='row'>
											...
											<div class='col-sm-8'>
												...
												$(document).ready(function() {
													countItems("<?php echo session_id(); ?>", "messages");
												});
												</script>
											</div>
										</div>
								...
								<div class='row'>
									<div class='form-group'>
										<div class='row'>
											...
											<div class='col-sm-7'>
												<input type='date' name='from' class='form-control' value='<?php echo date("Y-m-d"); ?>' id='from_logs' oninput='countItems("<?php echo session_id(); ?>", "logs");'>
											</div>
											<div class='col-sm-1'>
												<a class='date_info' title='<?php echo $m['date_info']; ?>'><span class='glyphicon glyphicon-exclamation-sign' style='font-size: 24px;'></span></a>
											</div>
									...
									<div class='form-group'>
										<div class='row'>
											...
											<div class='col-sm-8'>
												...
												<script>
												$(document).ready(function() {
													countItems("<?php echo session_id(); ?>", "logs");
												});
												</script>
											</div>
										</div>
								...
								<div class='row'>
									<div class='form-group'>
										<div class='row'>
											...
											<div class='col-sm-7'>
												<input type='date' name='from' class='form-control' value='<?php echo date("Y-m-d"); ?>' id='from_users' oninput='countItems("<?php echo session_id(); ?>", "users");'>
											</div>
											<div class='col-sm-1'>
												<a class='date_info' title='<?php echo $m['date_info']; ?>'><span class='glyphicon glyphicon-exclamation-sign' style='font-size: 24px;'></span></a>
											</div>
									...
									<div class='form-group'>
										<div class='row'>
											...
											<div class='col-sm-8'>
												...
												<script>
												$(document).ready(function() {
													countItems("<?php echo session_id(); ?>", "users");
												});
												</script>
											</div>
										</div>
								...
								<div class='row'>
									<div class='form-group'>
										<div class='row'>
											...
											<div class='col-sm-8'>
												<select name='based' class='form-control' id='based' onchange='countItems("<?php echo session_id(); ?>", "users");'>
							...
							<div class='modal-dialog' id='delete_modal_content'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
										...
										<script>
										$(document).ready(function() {
											countItems("<?php echo session_id(); ?>", "delete_inactive");
										});
										</script>
							...
							<div class='modal-dialog' id='delete_modal_content'>
								<div class='modal-content'>
									...
									<div class='modal-body'>
										...
										<script>
										$(document).ready(function() {
											countItems("<?php echo session_id(); ?>", "delete_never_loggedin");
										});
										</script>
			...
			<?php
			$log = mysqli_query($con,"SELECT * FROM log ORDER BY id DESC");
				...
				<table class='table table-striped table-hover' id='ltable'>
					...
					<tbody>
						...
						while($l = mysqli_fetch_array($log)) {
							$lip = $l['ip'];
							$blocked = mysqli_query($con,"SELECT * FROM blocks WHERE ip='$lip'");
			...
			<?php
			$timenow = time();
			$blocks = mysqli_query($con,"SELECT * FROM blocks WHERE until > ". $timenow ." OR until='0' OR until='' ORDER BY id DESC");
			...
			if(!empty($_GET['uid'])) {
							...
							<div class='row row-2'>
								...
								<div class='col-md-8'>
									...
									<div class='form-group'>
										<label class='col-sm-4 control-label'><?php echo $m['ip']; ?></label>
										<div class='col-sm-8'>
											<?php echo "<a href='?page=statistics&ip=". $u['ip'] ."'>". $u['ip'] ."</a>"; ?>
										</div>
									</div>
									...
									<div class='form-group'>
										...
										<div class='col-sm-8'>
											<?php
											$user_logins = mysqli_query($con,"SELECT * FROM log WHERE success='1' AND uid='$uid'");
				...
				$users = mysqli_query($con,"SELECT * FROM users ORDER BY id");
				...
				<br>
					<table class='table table-striped table-hover' id='utable'>
						...
						<tbody>
							...
							while($u = mysqli_fetch_array($users)) {
								$userid = $u['id'];
								$checkban = mysqli_query($con,"SELECT * FROM bans WHERE uid='$userid'");
							?>
					...
					<div class='form-group' id='actions'>
						<h3><?php echo $m['options_for_selected']; ?></h3><br>
